...
export class SeatsComponent implements OnInit {
  ...
  onBook(amount:number)
  {

    this.id=this.route.snapshot.params['id'];
    this.admin.seatNo= this.setSeat.seatNo;
    this.admin.amount=amount;
   // alert(this.setSeat.seatNo+" "+amount+" "+this.id);
    this.busBookingService.busStatus(this.id,this.admin);
    this.router.navigate(['book',this.id,this.admin.seatNo,this.admin.amount]); 
